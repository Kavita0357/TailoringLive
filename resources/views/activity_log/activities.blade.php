...
<div class="table-responsive">
    <table class="table table-condensed table-bordered table-striped" style="width: 100%;">
        <thead>
            <tr>
            <th style="width: 25%;">@lang('lang_v1.date')</th>
            <th style="width: 25%;">@lang('messages.action')</th>
            <th style="width: 25%;">@lang('brand.note')</th>
            <th style="width: 25%;">@lang('lang_v1.by')</th>
            </tr>
        </thead>
        <tbody>
