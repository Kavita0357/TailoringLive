...
<div class="modal-dialog modal-dialog-centered modal-md" role="document">
    <div class="modal-content">
        {!! Form::open([
            'url' => action([\App\Http\Controllers\MeasurementController::class, 'store']),
            'method' => 'post',
            'id' => 'measurement_add_form',
        ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="gridSystemModalLabel">@lang('tailoring.add_measurement')</h4>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('measurement_name', null, [
                ...
                {{-- <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('sub_measurements[]', $sub_measurements, null, [
