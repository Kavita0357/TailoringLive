<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\AccountController::class, 'postFundTransfer']),
            'method' => 'post',
            'id' => 'fund_transfer_form',
            'files' => true,
        ]) !!}
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                {!! Form::label('transfer_fee', __('tailoring.transfer_fee') . ':*') !!}
                {!! Form::text('transfer_fee', 0, [
                    'class' => 'form-control input_number',
                    'required',
                    'placeholder' => __('tailoring.transfer_fee'),
                ]) !!}
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::text('operation_date', null, [
                        'class' => 'form-control',
                        'required',
                        'placeholder' => __('messages.date'),
                        'id' => 'od_datetimepicker',
                    ]) !!}
