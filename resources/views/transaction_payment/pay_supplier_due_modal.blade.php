<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\TransactionPaymentController::class, 'postPayContactDue']),
            'method' => 'post',
        ...
        <div class="modal-body">
            <div class="row">
                ...
                @elseif(in_array($due_payment_type, ['sell', 'order']))
                    <div class="col-md-6">
                        <div class="well">
                    ...
                    <div class="col-md-6">
                        <div class="well">
                            <strong>@lang('tailoring.total_orders'): </strong><span class="display_currency"
                                data-currency_symbol="true">{{ $contact_details->total_order_invoice }}</span><br>
                            ...
                            <strong>@lang('contact.total_paid'): </strong><span class="display_currency"
                                data-currency_symbol="true">{{ $contact_details->total_order_paid }}</span><br>
                            ...
                            @endif
                            <br>
                            <strong>@lang('tailoring.total_order_due'): </strong><span class="display_currency"
                                data-currency_symbol="true">{{ $contact_details->total_order_invoice - $contact_details->total_order_paid }}</span><br>
                        </div>
                    </div>
            ...
            @if (config('constants.show_payment_type_on_contact_pay') &&
                    ($due_payment_type == 'purchase' || $due_payment_type == 'sell'))
                @php
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('is_reverse', $reverse_payment_types, 0, [
            ...
            <div class="row payment_row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        @php
                            $total_due =
                                $contact_details->total_order_invoice -
                                $contact_details->total_order_paid +
                                ($contact_details->total_invoice - $contact_details->total_paid);
                        @endphp
