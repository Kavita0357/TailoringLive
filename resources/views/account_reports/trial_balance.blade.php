    ...
    <section class="content">
        ...
        <div class="box box-solid">
            ...
            <div class="box-footer">
                <button type="button"
                    class="tw-dw-btn tw-dw-btn-primary tw-text-white no-print pull-right"onclick="window.print()">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function update_trial_balance() {
            ...
            $.ajax({
                url: "{{ action([\App\Http\Controllers\AccountReportsController::class, 'trialBalance']) }}?end_date=" +
