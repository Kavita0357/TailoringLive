<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::hidden('tailor_id', $tailor->id) !!}
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="well">
                        <strong>@lang('tailoring.tailor_master'): </strong>{{ $tailor->name }}<br>
                        <strong>@lang('tailoring.mobile'): </strong>{{ $tailor->mobile }}<br><br>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="well">
                        <strong>@lang('tailoring.total_wages'): </strong><span class="display_currency"
                            data-currency_symbol="true">{{ $tailor->total_wages }}</span><br>
                        <strong>@lang('tailoring.total_wages_paid'): </strong><span class="display_currency"
                            data-currency_symbol="true">{{ $tailor->total_wages_paid }}</span><br>
                        <strong>@lang('tailoring.total_wages_due'): </strong><span class="display_currency"
                            data-currency_symbol="true">{{ $tailor->total_wages_due }}</span><br>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('amount', @num_format($tailor->total_wages_due), [
                                'class' => 'form-control input_number payment_amount',
                                'required',
                                'placeholder' => __('sale.amount'),
                                'data-rule-max-value' => $tailor->total_wages_due,
                                'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => @num_format($tailor->total_wages_due)]),
                            ]) !!}
                        </div>
                    </div>
                </div>
