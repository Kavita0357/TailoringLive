...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\SellingPriceGroupController::class, 'update'], [$spg->id]),
            'method' => 'put',
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('auto_price_group', 1, $spg->auto_price_group, [
                            'class' => 'input-icheck',
                            'id' => 'auto_price_group',
                        ]) !!} {{ __('tailoring.auto_price_group') }}
                    </label>
                </div>
            </div>

            <div class="form-group auto-price @if (!$spg->auto_price_group) hide @endif">
            ...
            <div class="form-group auto-price @if (!$spg->auto_price_group) hide @endif">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('discount_amount', @num_format($spg->discount_amount), [
