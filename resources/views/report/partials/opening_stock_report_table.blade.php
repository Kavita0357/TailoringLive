<table class="table table-striped">
    ...
    <tr>
        <th>{{ __('home.total_purchase') }}:<br><small class="text-muted">(@lang('product.exc_of_tax'), @lang('sale.discount'))</small>
        </th>
        <td>
    ...
    <tr>
        <th>{{ __('tailoring.total_wages') }}:</th>
        <td>
            <span class="display_currency" data-currency_symbol="true">{{ $data['total_wages'] }}</span>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <span class="display_currency"
                data-currency_symbol="true">{{ $data['total_purchase_additional_expense'] }}</span>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <span class="display_currency"
                data-currency_symbol="true">{{ $data['total_transfer_shipping_charges'] }}</span>
        </td>
    </tr>
    <tr>
