                ...
                <table class="table table-bordered table-striped" id="supplier_report_tbl">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('tailoring.total_orders')</th>
                            <th>@lang('tailoring.total_order_due')</th>
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            ...
                            <td><span class="display_currency" id="footer_total_order_invoice" data-currency_symbol ="true"></span></td>
                            <td><span class="display_currency" id="footer_total_order_due" data-currency_symbol ="true"></span></td>
