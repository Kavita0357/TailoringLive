    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 individual" @if ($contact->contact_type == 'business' || empty($contact->contact_type)) style="display: none;" @endif>
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white center-block more_btn"
                ...
                <div id="more_div" class="hide">
                    ...
                    @if (!empty($common_settings['is_enabled_export']))
                        ...
                        @endphp
                        @for ($i; $i <= 6; $i++)
                            <div class="col-md-6 export_div" style="display: none;">
                                <div class="form-group">
