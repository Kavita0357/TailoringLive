...
<div
    ...
    <div class="tw-px-5 tw-py-3 pos-header">
                ...
                @if (in_array('tailoring', $enabled_modules))
                    @can('sell.create')
                        <a href="{{ route('cloth_pos.create') }}"
                            ...
                            <svg aria-hidden="true" class="tw-size-5 tw-hidden md:tw-block"
