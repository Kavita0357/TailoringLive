            ...
            @slot('tool')
                <div class="box-tools">
                    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                        href="{{ route(Request::is('cloth-orders*') ? 'cloth_orders.create' : 'sells.create', ['status' => 'draft']) }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                "ajax": {
                    "url": `${order_type == 'order' ? `/cloth-orders/draft-dt?is_quotation=0&type=${order_type}` : '/sells/draft-dt?is_quotation=0'}`,
                    "data": function(d) {
