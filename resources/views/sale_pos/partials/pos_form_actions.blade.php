...
<div class="row">
    <div
        class="pos-form-actions tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] pos-footer tw-cursor-pointer">
        <div
            class="tw-bg-white tw-rounded-xl tw-flex tw-items-center tw-justify-between tw-flex-col sm:tw-flex-row md:tw-flex-row lg:tw-flex-row xl:tw-flex-row tw-gap-2 tw-px-4 tw-py-0 tw-overflow-x-auto tw-w-full pos-sub-footer">
