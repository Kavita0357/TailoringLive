                                ...
                                <div class="col-md-3 col-xs-12 tw-mb-7 tw-w-auto  tw-h-28  tw-cursor-pointer main-category-div  no-print"
                                    ...
                                    <div
                                        ...
                                        <div class="tw-dw-card-actions tw-justify-center">
                                            <button type="button"
                                                class="tw-dw-btn tw-dw-btn-accent tw-dw-btn-outline tw-dw-btn-sm main-category tw-mb-2"
                                                data-value="{{ $category['id'] }}"
                                                data-parent="0">{{ __('lang_v1.all') }}</button>
                                            @if (!empty($category['sub_categories']))
                                                <button type="button"
                                                    class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-outline tw-dw-btn-sm main-category tw-mb-2"
                                                    data-parent="1" data-value="{{ $category['id'] }}"
                                                    data-name="{{ $category['name'] }}">@lang('pagination.next')</button>
                                            @endif
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="tw-dw-drawer tw-dw-drawer-end">
                ...
                <div class="tw-dw-drawer-content">
                    <label for="cloth-list-btn"
                        class="tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 hover:tw-from-indigo-600 hover:tw-to-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 active:tw-from-indigo-700 active:tw-to-blue-700 lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl tw-h-12 tw-cursor-pointer">
                        @lang('tailoring.cloths')
                    </label>
                </div>
            </div>
        </div>
        <div class="col-sm-6 !tw-px-2" id="product_list_div">
            <div class="tw-dw-drawer tw-dw-drawer-end">
                ...
                <div class="tw-dw-drawer tw-dw-drawer-end">
                    ...
                    <div class="tw-dw-drawer-content">
                        ...
                        <label for="my-drawer-brand"
                            class="tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 hover:tw-from-indigo-600 hover:tw-to-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 active:tw-from-indigo-700 active:tw-to-blue-700 lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl tw-h-12 tw-cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="tw-w-5 icon icon-tabler icon-tabler-brand-beats" width="44" height="44"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
<div class="row">
    ...
    @if ($pos_type == 'order')
        <div class="col-md-12">
            <div class="eq-height-row" id="cloth_list_body"></div>
        </div>
        <div class="col-md-12">
            <div class="eq-height-row" id="product_list_body" style="display: none"></div>
        </div>
    @else
        <div class="col-md-12">
