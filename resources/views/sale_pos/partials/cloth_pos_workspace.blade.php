                ...
                <div class="{{ $col_class }}">
                    <div class="cloth-custom-input-group">
                        ...
                        <input type="hidden" id="default_customer_id"
                            value="{{ $transaction->contact->id ?? ($walk_in_customer['id'] ?? '') }}">
                        <input type="hidden" id="default_customer_name"
                            value="{{ $transaction->contact->name ?? ($walk_in_customer['name'] ?? '') }}">
            ...
            <div class="cloth-pos-table-wrap">
                <table class="table" id="pos_header_table" style="margin-bottom: 0;">
                    <thead style="font-size:12px;">
                        <tr>
                            <th class="cloth-product">@lang('tailoring.cloth_product')</th>
                            <th class="qty text-center">@lang('sale.qty')</th>
                            <th class="making-charge text-center">@lang('tailoring.making_charge')</th>
                            <th class="tailoring-master text-center">@lang('tailoring.assign_to_tailoring_master')</th>
                            <th class="subtotal text-center">@lang('sale.subtotal')</th>
                            <th class="remove-column text-center">
