    ...
    <div class="col-md-12">
        <div class="row align-items-start">
            ...
            <div class="col-md-3">
                ...
                <div @if (!Gate::check('disable_discount') || auth()->user()->can('superadmin') || auth()->user()->can('admin')) @else style="display:none" @endif>
            ...
            <div class="col-md-3">
                ...
                <div>
                    ...
                    <input type="hidden" name="delivery_person" id="delivery_person"
                        value="@if (empty($edit)) {{ '' }}@else{{ $transaction->delivery_person }} @endif">
