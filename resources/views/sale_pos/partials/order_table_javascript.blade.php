<script type="text/javascript">
    $(document).ready(function() {
        ...
        if ($(document).find('#sell_list_filter_date_range').length > 0) {
            $('#sell_list_filter_date_range').daterangepicker(
                dateRangeSettings,
                function(start, end) {
                    $('#sell_list_filter_date_range').val(start.format(moment_date_format) + ' ~ ' + end
        ...
        cloth_table = $('#cloth_table').DataTable({
            processing: true,
            serverSide: true,
            fixedHeader: false,
            fixedHeader: false,
            ...
            "fnDrawCallback": function(oSettings) {
                __currency_convert_recursively($('#cloth_table'));
            },
