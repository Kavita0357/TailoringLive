                        ...
                        <tr>
                            <td>
                                <div class="{{ $col }} col-xs-6 d-inline-table">
                                    ...
                                    @endphp
                                    @if (!Gate::check('disable_express_checkout') || auth()->user()->can('superadmin'))
                                        <span class="@if (!$is_discount_enabled && !$is_rp_enabled) hide @endif">
                                            ...
                                            <br />
                                            <i class="fas fa-pen cursor-pointer" id="pos-edit-discount"
                                ...
                                <div class="{{ $col }} col-xs-6 d-inline-table">
                                    ...
                                    <span class="@if ($pos_settings['disable_order_tax'] != 0) hide @endif">
                                        ...
                                        <br />
                                        <i class="fas fa-pen cursor-pointer" title="@lang('sale.edit_order_tax')"
                                ...
                                <div class="{{ $col }} col-xs-6 d-inline-table">
                                    ...
                                    <span class="@if ($pos_settings['disable_discount'] != 0) hide @endif">
                                        ...
                                        <br />
                                        <i class="fas fa-pen cursor-pointer" title="@lang('sale.shipping')"
                                ...
                                <div class="col-sm-3 col-xs-12 d-inline-table">
                                    ...
                                    <small class="hide" id="round_off"><br>(@lang('lang_v1.round_off'): <span
                                            id="round_off_text"></span>)</small>
                                    <br />
