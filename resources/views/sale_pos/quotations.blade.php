            ...
            @slot('tool')
                <div class="box-tools">
                    ...
                    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                        href="{{ route(Request::is('cloth-orders*') ? 'cloth_orders.create' : 'sells.create', ['status' => 'quotation']) }}">
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            const order_type = ('{{ Request::is('cloth-orders*') ? 'order' : 'sell' }}');
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                "ajax": {
                    "url": `${order_type == 'order' ? `/cloth-orders/draft-dt?is_quotation=1&type=${order_type}` : '/sells/draft-dt?is_quotation=1'}`,
                    "data": function(d) {
