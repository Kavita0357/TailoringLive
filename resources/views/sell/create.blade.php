...
@php
    ...
    if ($sale_type == 'sales_order') {
        ...
        if (!empty($status) && $status == 'draft') {
            $title = __('tailoring.add_draft_order');
        } else {
            $title = __('tailoring.add_order');
        }
    }
    $filtered_statuses = $sale_type == 'order' ? collect($statuses)->except('proforma')->toArray() : $statuses;
@endphp
...
@section('content')
    ...
    <section class="content no-print">
        ...
        <input type="hidden" id="default_location_name" value="{{ $default_location['name'] }}">
