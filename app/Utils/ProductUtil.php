...
class ProductUtil extends Util
{
    ...
    public function calculateClothInvoiceTotal($cloths,$discount = null, $uf_number = true)
    {
        if (empty($cloths)) {
            return false;
        }
        ...
        foreach ($cloths as $cloth) {
            $unit_price = $uf_number ? $this->num_uf($cloth['unit_price_inc_tax']) : $cloth['unit_price_inc_tax'];
            $quantity = $uf_number ? $this->num_uf($cloth['quantity']) : $cloth['quantity'];
