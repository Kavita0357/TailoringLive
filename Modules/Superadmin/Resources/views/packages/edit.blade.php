        ...
        <div class="box box-solid">
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('cloths_count', __('superadmin::lang.cloths_count') . ':') !!}
                            {!! Form::number('cloths_count', $packages->cloths_count, ['class' => 'form-control', 'required', 'min' => 0]) !!}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('orders_count', __('superadmin::lang.orders_count') . ':') !!}
                            {!! Form::number('orders_count', $packages->orders_count, ['class' => 'form-control', 'required', 'min' => 0]) !!}
                    ...
                    @foreach ($modules as $k => $v)
                        <div class="col-sm-3">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('enabled_modules[]', $k, isset($packages->$k) && $packages->$k == 1, [
                                        'class' => 'input-icheck',
                                    ]) !!}
                                    {{ $v['name'] }}
                                </label>
