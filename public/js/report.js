$(document).ready(function () {
    ...
    supplier_report_tbl = $('#supplier_report_tbl').DataTable({
        ...
        columns: [
            { data: 'name', name: 'name' },
            { data: 'total_order_invoice', name: 'total_order_invoice' },
            { data: 'order_due', name: 'order_due' },
        ...
        fnDrawCallback: function (oSettings) {
            ...
            var total_order_invoice = sum_table_col($('#supplier_report_tbl'), 'total_order_invoice');
            $('#footer_total_order_invoice').text(total_order_invoice);

            var total_order_due = sum_table_col($('#supplier_report_tbl'), 'total_order_due');
            $('#footer_total_order_due').text(total_order_due);
    ...
    $('#stock_report_filter_form #location_id, #stock_report_filter_form #category_id, #stock_report_filter_form #sub_category_id, #stock_report_filter_form #brand, #stock_report_filter_form #unit,#stock_report_filter_form #view_stock_filter,  #stock_report_filter_form #stock_status'
    ).change(function () {
