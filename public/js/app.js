$(document).ready(function () {
    ...
    if (contact_table_type == 'supplier') {
        var columns = [
            ...
            { data: 'balance', name: 'balance', searchable: false }, // maps to 'advance_balance'
            { data: 'created_at', name: 'contacts.created_at' }, // 'added_on'
            { data: 'address', name: 'address', orderable: false },
            { data: 'mobile', name: 'mobile' },
            { data: 'due', searchable: false, orderable: false }, // total_purchase_due
            { data: 'return_due', searchable: false, orderable: false }, // total_purchase_return_due
        ...
        { data: 'last_order_date', searchable: false, orderable: false },
        { data: 'order_due', searchable: false },
...
function show_product_type_form() {
    ...
    const typeVal = $(document).find("#type").val();
    ...
    var action = $(document).find("#type").attr('data-action');
    var product_id = $(document).find("#type").attr('data-product_id');
    $.ajax({
        method: 'POST',
        url: '/products/product_form_part',
        dataType: 'html',
        data: { type: typeVal, product_id: product_id, action: action },
        success: function (result) {
            if (result) {
