...
use App\Http\Controllers\ClothCustomizationController;
...
use App\Http\Controllers\SubMeasurementController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/home/orders-payment-dues', [HomeController::class, 'getOrdersPaymentDues']);
    ...
    Route::resource('sub-measurements', SubMeasurementController::class);
    Route::resource('styles', StyleController::class);

    Route::get('/cloths/details/{id}', [ClothController::class, 'getClothDetails']);
    Route::get('/cloths/all-details/{id}', [ClothController::class, 'getClothAllDetails']);
    Route::resource('cloths', ClothController::class);

    Route::post('/cloth-customizations/store-or-update', [ClothCustomizationController::class, 'storeOrUpdate'])->name('cloth-customizations.storeOrUpdate');
    ...
    Route::get('/sells/draft-dt', [SellController::class, 'getDraftDatables'])->name('sells.draft_dt');
    ...
    Route::get('/cloth-orders/quotations', [SellController::class, 'getQuotations'])->name('cloth_orders.quotations');
    Route::get('/cloth-orders/drafts', [SellController::class, 'getDrafts'])->name('cloth_orders.drafts');
    Route::get('/cloth-orders/draft-dt', [SellController::class, 'getDraftDatables'])->name('cloth_orders.draft_dt');
    Route::get('/cloth-orders/{cloth_order}/edit', [SellController::class, 'edit'])->name('cloth_orders.edit');
    Route::get('/cloth-orders/convert-to-final-order/{id}', [SellPosController::class, 'convertToFinalOrder']);
    ...
    Route::resource('cloth-orders', SellController::class)
        ->names('cloth_orders')->except(['show']);
    ...
    Route::get('/tailor-master/edit/{id}', [ManageUserController::class, 'editTailorMaster'])->name('tailor_master.edit');
    ...
    Route::get('/reports/tailor-master-payment-report', [ReportController::class, 'tailorMasterPaymentReport']);
    ...
    Route::post('/messaging/send-sms', [MessagingController::class, 'sendSms']);
